...
//
//   const CountryInterface = Convert.toCountryInterface(json);
//
...
export class Convert {
  public static toCountryInterface(json: string): CountryInterface[] {
    return cast(JSON.parse(json), a(r('CountryInterface')));
  }

  public static CountryToJsonInterface(value: CountryInterface[]): string {
    return JSON.stringify(uncast(value, a(r('CountryInterface'))), null, 2);
  }
}
...
const typeMap: any = {
  ...
  Currencies: o([{ json: 'MXN', js: 'MXN', typ: r('Mxn') }], false),
  Mxn: o(
    [
